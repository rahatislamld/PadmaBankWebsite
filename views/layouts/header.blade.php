    ...
    <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
        ...
        <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1">
                <li class="u-nav-item">
                    <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-body-alt-color u-text-hover-palette-2-base" href="{{asset('')}}" style="padding: 10px 20px;font-weight: bold" >Home</a>
                </li>
                <li class="u-nav-item">
