...
use App\Http\Controllers\Admin\applinkController;
use App\Http\Controllers\Admin\exchange_rateController;
...
// });
Route::get('/applinks/create', [applinkController::class, 'create'])->name('applinks.create');
Route::post('/applinks/store', [applinkController::class, 'store'])->name('applinks.store');
Route::get('/applinks', [applinkController::class, 'index'])->name('applinks');
Route::post('/applinks/destroy/{id}', [applinkController::class, 'destroy'])->name('applinks.destroy');


Route::get('/exchange_rates/create', [exchange_rateController::class, 'create'])->name('exchange_rates.create');
Route::post('/exchange_rates/store', [exchange_rateController::class, 'store'])->name('exchange_rates.store');
Route::post('/exchange_rates/update/{id}', [exchange_rateController::class, 'update'])->name('exchange_rates.update');
Route::get('/exchange_rates/edit/{id}', [exchange_rateController::class, 'edit'])->name('exchange_rates.edit');
Route::get('/exchange_rates', [exchange_rateController::class, 'index'])->name('exchange_rates');
Route::post('/exchange_rates/destroy/{id}', [exchange_rateController::class, 'destroy'])->name('exchange_rates.destroy');
