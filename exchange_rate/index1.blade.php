        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                  ...
                  @endif --}}
                  <a href="{{ route('exchange_rates.create') }}"class="btn btn-round btn-success" style="float: right;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('exchange_rates.edit', $exchange_rates->id)}}"   class="btn btn-primary btn-sm">Edit</a>
                                        <form action="{{ route('exchange_rates.destroy', $exchange_rates->id)}}" method="post" style="display: inline-block">
                                            @csrf
