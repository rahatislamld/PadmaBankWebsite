...
overflow-x: scroll;
    ...
    <div class="row" style="padding: 10px 50px 0px 50px; height: 350px;">
        ...
        <div class="col-3">
            ...
            <div class="div-scroll">
                <h6 style="text-align: center"><b>Top Ten Branch</b></h6>
                <table border="1px" align="center">
                  
                    @foreach ($top_branches as $item)
                    <tr>
                        <td style="text-align: center"> <a  style="text-align: center" href="{{ route('general.team', ['home' => 'sys_branches', 'id' =>  $item['id']]) }}">
                            {{ $item['name'] }}
                        </a></td>
                        {{-- <td >{{ $item->tt_buy }}</td>
                        <td >{{ $item->tt_sell }}</td> --}}
        ...
        <div class="col-3">
            ...
            <div class="div-scroll">
                <h6 style="text-align: center"><b>Exchange rates</b></h6>

                <table border="1px" align="center">
                
                <tr> <th> currency </th> <th>TT(buy)</th> <th>TT(sell)</th> </tr>
